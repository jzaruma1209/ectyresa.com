...
import CartIcon from "../../features/shared/CartIcon";
    ...
    <header className={`header ${isHidden ? "header--hidden" : ""}`}>
        ...
        <div className="top-bar-container">
          ...
          <div className="top-bar-left desktop-only">
            <span className="location-text">
              La Troncal, av 25 de Agosto y Galapagos
            </span>
          </div>
      ...
      {menuOpen && (
        <div className="mobile-menu">
          ...
          <a href="#" className="mobile-menu-link" onClick={() => setMenuOpen(false)}>Productos</a>
          <a href="#" className="mobile-menu-link" onClick={() => setMenuOpen(false)}>Sobre Nosotros</a>
          <a href="#" className="mobile-menu-link" onClick={() => setMenuOpen(false)}>Contactanos</a>
