const PromoBanner = () => {
  return (
    <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-900/70 px-6 py-[5px] after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10 sm:px-3.5 sm:before:flex-1">
      <style>{`
        @keyframes marquee {
      ...
      <div className="flex w-full items-center gap-x-4 gap-y-2">
        <div className="relative flex-1 overflow-hidden h-6 flex items-center">
          <div
            className="flex items-center gap-[188px] whitespace-nowrap text-sm/6 text-gray-100"
            style={{
